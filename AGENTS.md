...
- Timesheet / Approvals / Audit / Calendar / Clients / Tags are live from SQLite. Do not start kiosk, GPS, SSO, or invoicing UI.

## Rules

1. Claim **one** open stream from HANDOFF.md §6. Do not start kiosk, GPS, SSO, or invoicing UI.
